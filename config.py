...
BOT_USERNAME = os.getenv("BOT_USERNAME", "trendyol_muzik_bot")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/yasamakbuysa")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/yasamakbuysa")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/gizemli_kral00")
YOUTUBE = os.getenv("YOUTUBE", "https://youtube.com/@yolcu")
GITHUB = os.getenv("GITHUB", "https://github.com/porn")
DONATE = os.getenv("DONATE", "https://t.me/yasamakbuysa")
